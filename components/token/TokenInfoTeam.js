            ...
            <div className="flex flex-wrap lg:justify-evenly lg:flex-nowrap w-full lg:space-x-2 lg:divide-x divide-gray-400 divide-opacity-20">
              <div className="lg:text-center flex-0 flex-srink-0 lg:w-full pr-6 lg:pr-0">
                <div className="field-label">
                  <span className="field-label--text">{t("Location")}</span>
                </div>
                <div className="mb-2">
                  <strong className="">
              ...
              <div className="lg:text-center flex-0 flex-srink-0 lg:w-full pr-6 lg:pr-0">
                <div className="field-label">
                  <span className="field-label--text">{t("Founded")}</span>
                </div>
                <div className="mb-2">
                  <strong className="">
              ...
              <div className="lg:text-center flex-0 flex-srink-0 lg:w-full pr-6 lg:pr-0">
                <div className="field-label">
                  <span className="field-label--text">{t("Employees")}</span>
                </div>
                <div className="mb-2">
                  <strong className="">
              ...
              <div className="lg:text-center flex-0 flex-srink-0 lg:w-full pr-6 lg:pr-0">
                <div className="field-label">
                  <span className="field-label--text" title="Last Funding Type">
                    {t("Last Funding")}
                  </span>
                </div>
                <div className="mb-2">
              ...
              <div className="lg:text-center flex-0 flex-srink-0 lg:w-full">
                <div className="field-label">
                  <span className="field-label--text">{t("Headquarter")}</span>
                </div>
                <div className="mb-2">
          ...
          <div>
            <div className="w-full mt-8 lg:mt-16">
              <h2 className="lg:text-center text-xl lg:text-2xl font-semibold">
                {t("Who is building Axie Infinity", {
                  provider: tokenData.name,
                })}
              </h2>
