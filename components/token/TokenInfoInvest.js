                  ...
                  <div className="step--content">
                    <form>
                      ...
                      <div className="opacity-70 rounded text-sm p-2 mt-2 form-message text-gray-900 form-message--notice bg-green-400">
                        ...
                        {tokenData?.platform?.networkName}. Please make sure
                        that you enter the correct{" "}
                        {tokenData?.platform?.networkName} wallet address.
                      </div>
                    </form>
                  </div>
                </div>
            ...
            <div className="card--wrapper mt-4">
              ...
              <div className="card--body p-3 lg:p-5 flex">
                ...
                <p>
                  ...
                  in Moniwar successfully. {investData?.tge_unlock}% of the
