export const Footer = () => {
  return (
    <div className="footer mt-8 lg:mt-16">
      ...
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
          ...
          <div>
            <p className="font-semibold tracking-wide text-gray-900">Apples</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  href="/"
          ...
          <div>
            <p className="font-semibold tracking-wide text-gray-900">Cherry</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  href="/"
