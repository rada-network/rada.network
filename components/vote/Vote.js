...
export const Vote = ({itemId, votes, page}) => {
  ...
  if (page === "detail" ){
    return (
      <btn className="justify-center flex-1 px-2 py-2 ml-4 text-white transition-all rounded-md md:px-3 md:py-3 btn item-center btn-project-vote bg-primary-700 hover:bg-primary-600" onClick={toggleVote}>
   ...
   return (
     <btn className="flex-col justify-center transition-all rounded-md btn w-icon-64 h-icon-64 btn-project-vote bg-gray-50 group-hover:bg-primary-700 group-hover:text-white bg-gradient-to-tr from-gray-50 to-gray-50 group-hover:from-primary-700 group-hover:to-primary-600" onClick={toggleVote}>
