      ...
      <div className="page-about-content">
        <div className="page-about-content--section">
          ...
          <div>
            <h3>What is RADA?</h3>
            <p>
              RADA is a news aggregator for Blockchain and Crypto investors.
            </p>
          </div>
        </div>
        ...
        <div className="page-about-content--section">
          ...
          <div>
            ...
            <p>
              <u>Phase 1</u>: The system will "scan" and collect all
              Blockchain/Crypto news from major newspapers in the world and
              Vietnam.
            </p>
            <p>
              <u>Phase 2</u>: Big data technology and AI recommend the most
              important news and information to ensure you do not miss any
              important opportunities in the Crypto market.
            </p>
            <p>
              Rada supports multi-language: users from any country will be
              navigated to the local language, with news being gathered from
              sources from the local press.
            </p>
          </div>
        </div>
