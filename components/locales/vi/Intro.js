  ...
  return (
    <div className="page-about">
      ...
      <div className="page-about-content">
        <h3>Rada.co là gì?</h3>
        <p>
          Rada.co là phiên bản “Báo mới” dành cho các nhà đầu tư Blockchain và
          Crypto.
        </p>

        <h3>Rada.co sẽ hoạt động như thế nào?</h3>
        <p>
          Bước 1: Hệ thống sẽ “quyét” toàn bộ các tin tức về Blockchain/Crypto
          các trang tin lớn trên thế giới và Việt Nam.
        </p>

        <p>
          Bước 2: Công nghệ Big data và AI đề xuất các tin tức, thông tin quan
          trọng nhất để đảm bảo bạn không bỏ lỡ cơ hội quan trọng nào trong thị
          trường Crypto.
        </p>

        <p>
          Rada.co hỗ trợ đa ngôn ngữ, các users đến từ quốc gia nào sẽ được điều
          hướng sang ngôn ngữ địa phương, sử dụng đầu vào là các nguồn tin từ
          báo chí địa phương.
        </p>
