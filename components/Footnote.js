      ...
      <div className="post-footer post-footer--rada">
        <div className="flex flex-col items-start">
          <div className="flex flex-col lg:flex-row lg:items-start !mb-0">
            <img
              className="w-5 lg:w-7 inline-block !ml-0 !mr-3 mb-2"
              src="https://cdn.rada.network/images/rada.svg"
              alt="RADA NETWORK"
            />
            <div className="flex flex-row lg:flex-col items-center lg:items-start">
              <strong className="logo--text lg:text-lg font-bold">RADA</strong>
              <span className="mx-1.5 text-base block lg:hidden">&bull;</span>
              <div className="text-sm lg:text-base lg:ml-0 !mb-0">
      ...
      >
        ...
        <span className="btn--text">
          ...
          >
            ...
            <span className="btn--text">Global Community</span>
          </a>
          ...
          >
            ...
            <span className="btn--text">Fanpage</span>
          </a>
          ...
          >
            ...
            <span className="btn--text">Vietnam Community</span>
          </a>
          ...
          >
            ...
            <span className="btn--text">RADA TV</span>
          </a>
          ...
          >
            ...
            <span className="btn--text">Tiktok</span>
          </a>
        </div>
      </div>
    </>
