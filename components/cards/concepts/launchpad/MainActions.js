        ...
        <div className="box-body">
          ...
          <nav aria-label="Progress">
            <ol role="list" className="steps">
              ...
              <li className="step">
                ...
                <a href="#" className="group flex items-center w-full">
                  <span className="px-4 py-2 flex items-center text-sm font-medium">
                    ...
                    <span className="ml-4 text-sm font-medium text-gray-900">Subscribe</span>
                  </span>
                </a>
              ...
              <li className="step">
                {/* Current Step */}
                <a href="#" className="px-4 py-2 flex items-center text-sm font-medium" aria-current="step">
                  ...
                  <span className="ml-4 text-sm font-medium text-primary-600">Application form</span>
                </a>
                {/* Arrow separator for lg screens and up */}
                <div className="step--arrow" aria-hidden="true">
                  <svg className="h-full w-full text-gray-300" viewBox="0 0 22 80" fill="none" preserveAspectRatio="none">
