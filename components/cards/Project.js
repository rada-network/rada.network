  ...
  return (
      <div className="flex-row items-center content-center card group card-project">
        ...
        <div className="card-body">
          ...
          <div className="card-body-footer">
            <div className="metadata-wrapper project-metadata-wrapper">
              ...
              <span className="mr-1 icon text-base"><RiChat1Fill /></span>
        ...
        <div className="card-footer">
          <btn
              className="flex-col justify-center transition-all rounded-md btn w-icon-64 h-icon-64 btn-project-vote bg-gray-50 group-hover:bg-primary-700 group-hover:text-white bg-gradient-to-tr from-gray-50 to-gray-50 group-hover:from-primary-700 group-hover:to-primary-600">
