...
import {createPostUri} from "../components/card-layouts/concepts/PostsList";
...
const utils = {
  ...
  createSiteMetadata : function({page,data,dataStore}){
    let base = {
      facebook : {},
      twitter : {},
    ...
    if (page === "Index"){
      return Object.assign(base,{
        title : process.env.NEXT_PUBLIC_GLOBAL_TITLE,
        description : process.env.NEXT_PUBLIC_GLOBAL_DESCRIPTION
      })
    }
    if (page === "IdeaDetail"){
    ...
    if (page === "Explore"){
      return Object.assign(base,{
        title : "Explore " + data.query,
        description : "latest news, social, idea for " + data.query
      })
    }
    if (page === "News"){
      return Object.assign(base,{
    ...
    if (page === "NewsDetail"){
      ...
      return Object.assign(base,{
        ...
        "og:url" : createPostUri(data.title,data.item,dataStore.lang),
        "article:tag" : keyword,
