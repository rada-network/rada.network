...
const utils = {
  ...
  createSiteMetadata : function({page,data,dataStore,subPage}, locales = [], asPath = ""){
    let base = {
      facebook : {},
      twitter : {},
      keyword : "crypto,blockchain networks,cardano,bitcoin,ada,btc,eth,ethereum",
    ...
    if (page === "Index"){
      return Object.assign(base,{
        title : "RADA Launchverse",
        description : "LaunchVerse is a product of RADA - The DAO-based AngelList for Blockchain. As a leading decentralized community-driven LaunchPad, we fund and launch the most promising Gamefi and Blockchain projects."
      })
    }
    if (page === "launchverse"){
      return Object.assign(base,{
    ...
    if (page === "IdeaDetail"){
      ...
      let keyword = keywords.map(function(item){
        return item[0]
      }).join(",")
      return Object.assign(base,{
        title : data.title,
    ...
    if (page === "Explore"){
      ...
      return Object.assign(base,{
        title : "Rada Network",
        description : "The DAO based AngelList for Blockchain" 
      })
    }
    if (page === "News"){
      return Object.assign(base,{
    ...
    if (page === "ItemDetail"){
      ...
      if (data.keywords !== null){ 
        try{
          ...
          keywords = Object.entries(keywords)
          keyword = keywords.map(function(item){
            return item[0]
          }).join(",")
        }
        catch(e){
      ...
      return Object.assign(base,{
        ...
        "article:author" : data.grabTopic !== null ? data.grabTopic.name : "Rada"
      })
    }
  ...
  {
    return slug(Text,{lowercase : true})
      .toLowerCase();
  },
  slug : function(str) {
