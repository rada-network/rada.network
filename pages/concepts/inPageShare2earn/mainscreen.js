                      ...
                      <form>
                        <div className="mb-4">
                          ...
                          <div className="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="fb-post-url" id="fb-post-url" className="inputbox inputbox-lg !pl-12 !pr-20" placeholder="Facebook's post link" />
                        ...
                        <div className="mb-4">
                          ...
                          <div className="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="twitter-post-url" id="twitter-post-url" className="inputbox inputbox-lg !pl-12 !pr-20" placeholder="Twitter's post link" />
                            <div className="absolute inset-y-0 right-0 flex items-center">
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mb-4">
                          ...
                          <div className="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="linkedin-post-url" id="linkedin-post-url" className="inputbox inputbox-lg !pl-12 !pr-20" placeholder="Linkedin's post link" />
                            <div className="absolute inset-y-0 right-0 flex items-center">
                            </div>
                          </div>
                        </div>
