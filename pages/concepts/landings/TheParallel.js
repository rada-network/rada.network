                        ...
                        <header className="hero flex flex-col md:flex-row py-8 mt-8">
                          <div className="">
                            ...
                            <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                              LaunchVerse is a product of RADA - The DAO-based
                              AngelList for Blockchain. As a leading
                              decentralized community-driven LaunchPad, we fund
                              and launch the most promising Gamefi and
                              Blockchain projects.
                            </p>
                          </div>
                              ...
                              <div className="media-player">
                                <div className="w-full h-full">
                                  <div className={`aspect-w-16 aspect-h-9`}>
                                    <iframe
                                      src={
                                        "https://www.youtube.com/embed/DEWHvVE7xr4"
                                      }
                            ...
                            > */}
                              ...
                              <div className="flex flex-col lg:flex-row lg:items-center md:pl-8">
                                <div className="">
                                  ...
                                  <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                    The Parallel is an Infinite Metaverse where
                                    players can limitlessly create everything,
                                    enjoy the unexpected experience that only
                                    Parallel can make.
                                  </p>
                                </div>
                        ...
                        <div className="mt-8">
                          ...
                          >
                            <div className="">
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                We make a unique tokenomic that encourage
                                community to share projects and earn RIR token.
                                The more you share, the more you earn. Both
                                parties can archive their goals easily.
                              </p>
                              <div className="mt-4">
                        ...
                        <div className="mt-16">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 mt-8">
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                We review projects and kyc team carefully so you
                                can invest safely
                              </p>
                            </div>
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                Tier system can help user that contribute most
                                to project get more reward
                              </p>
                            </div>
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                Launchverse support multi chain: Etherium, BSC
                                and Polygon
                              </p>
                            </div>
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                A Distribution Portal for projects to vest
                                project sold tokens
                              </p>
                            </div>
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                Help to incubate early stage project with our
                            ...
                            >
                              ...
                              <p className="text-sm lg:text-base leading-relaxed text-black dark:text-white text-opacity-70 dark:text-opacity-70 mt-4">
                                Fully function DAO with Governance model and
                        ...
                        <div className="footer mt-16 md:mt-24 pb-32 md:pb-24">
                          <div className="flex flex-col md:flex-row justify-between items-center">
                            <small className="text-sm leading-relaxed font-light text-black dark:text-white text-opacity-70 dark:text-opacity-70 max-w-md">
                              &copy; Copyright Rada Network 2021. All rights
                              reserved.
                            </small>
