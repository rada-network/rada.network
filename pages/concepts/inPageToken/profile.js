                      ...
                      <div className="list-group">
                        <div className="list-group--item !justify-start !items-start">
                          ...
                          <div>
                            ...
                            <p className="mb-2">
                              Complete all the folllowing tasks:
                            </p>
                            ...
                            <ol className="">
                              ...
                              <li className="mb-1">
                                ...
                                <a
                                  className="link"
                                  href="https://www.youtube.com/channel/UCZUun_BIo0GZgvBNsYSUjwQ/featured"
                                  rel="nofollow"
                                  target="_blank"
                                >
                                  RADA TV
                              ...
                              <li className="mb-1">
                                ...
                                <a
                                  className="link"
                                  href="https://www.facebook.com/groups/857926278494577"
                                  rel="nofollow"
                                  target="_blank"
                                >
                                  Facebook Group
                              ...
                              <li className="mb-1">
                                ...
                                <a
                                  className="link"
                                  href="https://discord.gg/2hmmK6P3"
                                  rel="nofollow"
                                  target="_blank"
                                >
                                  Dicord
                        ...
                        <div className="list-group--item !justify-start !items-start">
                          ...
                          <div>
                            <h3 className="font-semibold mt-1 mb-2 lg:mt-2">
                              TIER 2: $100 allocation{" "}
                              <span className="font-normal">(Guaranty)</span>
                            </h3>

                            <p className="mb-2">
                              Complete at least 1 of the folllowing tasks:
                            </p>
