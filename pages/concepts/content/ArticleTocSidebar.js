            ...
            <div class="flex h-full w-limiter-lg relative xl:px-4">
              ...
              <div class="tabbar page-tabs relative lg:left-8 xl:-left-1">
                <div class="tabbar--main">
                  <a class="tab-item" href="/vi/launchverse/parallel">
                    LaunchVerse
                  </a>
                  ...
                  >
                    <span class="token-symbol flex-shrink-0 lg:mr-2">
                      <img
                        src="https://media.rada.network/assets/e1a6619a-2209-44aa-820f-482171cb7299?format=webp&amp;width=128"
                        class="h-px-20 w-px-20"
                        alt="The Parallel"
                      />
                    </span>
                    <span class="tab-item--text">Thông tin PRL</span>
                  </a>
                  <a
                    class="tab-item"
                  ...
                  >
                    ...
                    <span class="tab-item--text">Share2Earn</span>
                  </a>
                </div>
              </div>
              <button class="btn btn-primary my-2 px-2 ml-auto lg:mr-3 xl:mr-12 text-sm flex">
                Kết nối
              </button>
            </div>
          </div>
