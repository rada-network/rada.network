              ...
              <div class="flex h-full w-limiter-lg relative xl:px-4">
                ...
                <div class="tabbar page-tabs relative lg:left-8 xl:-left-1">
                  <div class="tabbar--main">
                    <a class="tab-item" href="/vi/launchverse/parallel">LaunchVerse</a>
                    <span class="tab-item--divider"></span>
                    <a class="tab-item tab-item--active" href="/vi/launchverse/parallel/research"><span class="token-symbol flex-shrink-0 lg:mr-2"><img src="https://media.rada.network/assets/e1a6619a-2209-44aa-820f-482171cb7299?format=webp&amp;width=128" class="h-px-20 w-px-20" alt="The Parallel" /></span><span class="tab-item--text">Thông tin PRL</span></a>
