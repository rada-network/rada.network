    ...
    <>
      <StaticLayout meta={meta} >
        ...
        <div className="page-section">
            <a href="../user/profile" className="flex opacity-70 hover:opacity-100 items-center mb-4 uppercase">
                <span className="w-4 h-4 mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>arrow-left</title><path fill="currentColor" d="M22.548,10.561H5.437a.251.251,0,0,1-.165-.438l8.637-7.6a1.44,1.44,0,0,0-1.9-2.162L.828,10.2a2.4,2.4,0,0,0,0,3.6l11.179,9.837a1.44,1.44,0,0,0,1.9-2.161l-8.637-7.6a.251.251,0,0,1,.165-.438H22.548a1.44,1.44,0,0,0,0-2.879Z"/></svg>
                </span>
                Back
            </a>
            <div className="flex items-center">
                ...
                <div className="mr-auto inline-flex px-3 py-1 items-center rounded bg-gray-200 dark:bg-gray-800">
                    ...
                    <span className="ml-1">4 RIR</span>
                </div> 
                <div className="flex-1 mt-2 ml-2 w-100 text-gray-500">
                    <span>Your allocation is 10 RIR. You can top up 6 RIR to your account.</span>
                </div>
            </div>
            <div className="card--wrapper mt-4">
                ...
                <div className="card--body">
                    <div className="step--wrapper">
                        ...
                        <form>
                            <label for="rir-amount" className="flex inline-field--wrapper relative items-stretch">
                            ...
                            <div className="mt-1 text-right text-sm opacity-40">[100*rir_amount]USDT</div>
                        </form>
                    </div>
                </div>
                {/* End: Step 1 */}
                ...
                <div className="step--wrapper">
                    <div className="step--header flex">
                        ...
                        <h3>
                            Send <span className="font-semibold dark:text-white">[usdt_amout]USDT </span> to RADA&rsquo;s Treasury Wallet
                        </h3>
                ...
                <div className="step--wrapper">
                    ...
                    <form>
                        ...
                        <input className="inline--field" id="txh" type="text" />
                        </div>
            ...
            <div className="card--wrapper mt-5">
                ...
                <div className="card--body">
                    <div className="p-3 lg:p-5 flex items-center">
                        <span className="opacity-70 mr-3">05/10/2021 <time class="opacity-80">08:12</time></span>
                        <span className="w-3/6">Top up</span>
                        <span className="ml-2">5RIR</span>
                        <span className="mr-0 shink-0 ml-auto label label--inactive">Pending</span>
                    </div>
                    <div className="sep"></div>
                    <div className="p-3 lg:p-5 flex items-center">
                        <span className="opacity-70 mr-3">05/10/2021 <time class="opacity-80">08:12</time></span>
                        <span  className="w-3/6">Invested in MOWA</span>
                        <span className="ml-2">5RIR</span>
                        <span className="mr-0 shink-0 ml-auto label label--active">Succeeded</span>
                    </div>  
                    <div className="sep"></div>
                    <div className="p-3 lg:p-5 flex items-center">
                        <span className="opacity-70 mr-3">05/10/2021 <time class="opacity-80">08:12</time></span>
