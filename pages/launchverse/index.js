              ...
              <div className="w-limiter-xl py-8 lg:py-16 px-2 md:px-4 lg:px-8 xl:px-16">
                ...
                <div className="hero flex flex-col md:flex-row justify-center items-center mt-16 max-w-screen-md mx-auto">
                  <div className="text-center md:text-left">
                    <p className="text-2xl md:text-3xl xl:text-4xl font-altsans mb-4">
                ...
                <div class="mt-4 lg:mt-16 flex flex-col md:flex-row justify-center items-center">
                  <small class="text-sm leading-relaxed font-light text-black dark:text-white text-opacity-70 dark:text-opacity-70 max-w-md">
