    ...
    <>
      <StaticLayout meta={meta} >
        ...
        <div className="page-section text-center mt-1 mb-2 lg:mt-2">
          ...
          <div className="mt-4">
            <div className="flex">
              <h1 className="ml-auto text-2xl">{t("hello")}&nbsp;<strong>{user.name}</strong> #12345</h1>
              <a href="../concepts/TopUp" className="mr-auto ml-2 inline-flex px-3 py-1 items-center rounded bg-gray-200 dark:bg-gray-800">
            ...
            <div className="flex-1 mt-2 w-100 text-gray-500">
              ...
              <a href="../concepts/TopUp" className="btn-neutral px-2 py-1 rounded ml-2 text-sm uppercase font-semibold">Top up</a>
            </div>
          </div>
        </div>
